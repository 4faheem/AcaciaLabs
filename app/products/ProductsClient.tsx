  ...
  const productsList = [
    {
      ...
      description: "A complete operational and financial tracking system. Know exactly where every dollar is and what's happening across your entire business in real-time.",
      features: [
        "Workflow management",
        ...
        <div className="section-container">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold uppercase tracking-tight text-text-primary leading-tight">
              Products That <br />
              <span className="text-text-secondary">Eliminate Guesswork.</span>
            </h1>
