      ...
      <section className="relative py-32 bg-[#050505] border-t border-glass-border overflow-hidden">
        <div className="section-container">
          <MotionDiv
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20 border-b border-glass-border pb-12"
          >
            <div className="max-w-2xl">
              <span className="eyebrow">ARCHITECTURAL LEADERSHIP</span>
              <h2 className="text-4xl md:text-5xl font-bold text-text-primary uppercase tracking-tight">
                Systems Authority
              </h2>
              <p className="text-text-secondary text-base mt-4 max-w-lg">
                Meet the engineering and operations strategists directing the execution framework of Acacia Labs.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <MotionDiv
              ...
              className="border border-glass-border bg-glass-bg/40 p-8 rounded-sm hover:border-glass-border-hover transition-all duration-300 flex flex-col justify-between group"
            >
              <div>
                <span className="text-[9px] font-mono text-accent-blue tracking-widest uppercase block mb-4">Founder & CEO // Technical Lead</span>
                <h3 className="text-2xl font-bold uppercase tracking-tight text-text-primary group-hover:text-accent-blue transition-colors">
                  Fahim Kiama
                </h3>
                <p className="text-xs text-text-secondary leading-relaxed mt-4">
                  Directs strategic vision and system architecture. Focuses on edge capabilities, data consensus under network drops, and native African design constraints.
                </p>
              </div>
              <div className="border-t border-glass-border/40 pt-4 mt-8 flex justify-between items-center">
                <span className="text-[9px] font-mono text-text-muted">DAR ES SALAAM NODE</span>
                <Link href="/founder" className="text-[10px] font-bold tracking-[0.2em] uppercase text-accent-blue hover:text-text-primary transition-colors">
                  VIEW PROFILE &gt;
                </Link>
              </div>
            </MotionDiv>
            ...
            >
              <div>
                <span className="text-[9px] font-mono text-accent-cyan tracking-widest uppercase block mb-4">Chief Operating Officer // Exec Lead</span>
                <h3 className="text-2xl font-bold uppercase tracking-tight text-text-primary group-hover:text-accent-cyan transition-colors">
                  Gwamaka Johas
                </h3>
                <p className="text-xs text-text-secondary leading-relaxed mt-4">
                  Directs enterprise deployments and system integrations. Focuses on bridging complex digital ledgers with physical logistics and carrier mobile networks.
                </p>
              </div>
              <div className="border-t border-glass-border/40 pt-4 mt-8 flex justify-between items-center">
                <span className="text-[9px] font-mono text-text-muted">DAR ES SALAAM NODE</span>
                <Link href="/coo" className="text-[10px] font-bold tracking-[0.2em] uppercase text-accent-cyan hover:text-text-primary transition-colors">
                  VIEW PROFILE &gt;
                </Link>
              </div>
            </MotionDiv>
