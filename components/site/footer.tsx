...
import { company, footerLinks } from "@/lib/site";
    ...
    <footer className="border-t border-glass-border bg-primary-bg text-text-primary overflow-hidden relative">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12 py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4 relative z-10">
        ...
        <div className="space-y-6">
          ...
          <div className="text-[10px] font-bold uppercase tracking-[0.3em] text-accent-blue pt-4">Resources</div>
          <nav className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              {footerLinks.legal.map(link => (
                <Link key={link.label} href={link.href} className="hover:text-text-primary transition-colors">
                  {link.label}
                </Link>
              ))}
            </div>
