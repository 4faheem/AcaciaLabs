        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center gap-1 pt-2 -ml-2.5">
            <a
              ...
              aria-label="LinkedIn"
              className="inline-flex items-center justify-center min-w-[40px] min-h-[40px] text-text-muted hover:text-text-primary transition-colors duration-200 cursor-pointer"
            >
